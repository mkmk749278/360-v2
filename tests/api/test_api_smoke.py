...
def test_agents_returns_18_evaluators(client: TestClient) -> None:
    """API surface includes one entry per evaluator.  2026-07-15 added the
    18th evaluator (MEAN_REVERT; 2026-06-28 added the 17th, MOVER_AVWAP_SCALP)."""
