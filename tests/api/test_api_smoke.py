...
def test_agents_returns_19_evaluators(client: TestClient) -> None:
    """API surface includes one entry per evaluator.  2026-07-18 added the
    19th evaluator (RANGE_FADE; 2026-07-15 added the 18th, MEAN_REVERT)."""
